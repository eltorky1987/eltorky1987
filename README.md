...
### 🚀 نبذة عني (About Me)
مطور برمجيات مهتم بالأمن السيبراني، التشفير، وأنظمة التحكم الذكية. أعمل حالياً على تطوير أدوات حماية وتطبيقات تعتمد على Arduino و Python.

* 📍 المقر: **الإسكندرية، مصر**
* 🛠️ الأجهزة: **Realme C67 (Android Development & Testing)**
* 🔐 الاهتمامات: **Cybersecurity, PGP, Network Monitoring, AOSP**
...
### 📁 أبرز المشاريع (Highlighted Projects)
* **[Smart Smoke Detector](https://github.com/eltorky1987/SmokeDetector)**: نظام إنذار ذكي باستخدام حساسات MQ-2.
* **Agina Crypt**: أدوات تشفير وحماية متقدمة مكتوبة بلغة Python.
* **Network Optimization**: تخصيص إعدادات DNS والشبكات المنزلية لزيادة الأمان والأداء.

---

### 📊 لغات البرمجة الأكثر استخداماً
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=eltorky1987&layout=compact&theme=tokyonight&hide_border=true)
